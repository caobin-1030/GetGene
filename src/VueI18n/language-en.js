export const lang = {
  ...
  key:'Keywords',
  col:'color',
  pa:'Pathway annotation',
  reg:'Regulation',
  BP:'expression-BP correlation',
  CC:'expression-CC correlation',
  MF:'expression-MF correlation',
  er:'Expression regulation',
  epc:'Expression-pathway correlation',
  pvc:'P-value cutoff',
  rvc:'R-value cutoff',
  fa:'R-value cutoff',
  dat:'dataset(cancer type)',
  cm:'correlation methods',
  tm:'Test methods',
  tt:'T test',
  rst:'Rank sum test',
  xla:'X-label angle',
